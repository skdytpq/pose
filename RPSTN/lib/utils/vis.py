...
def save_batch_image_with_joints(dataset, batch_image, batch_joints, gt_val, batch_joints_vis,
    ...
    if dataset == 'pose_data':
       ...
       # skeleton = [[1,16],[2,4],[3,5],[2,4],[3,5],[4,6],[5,7],[10,8],[9,11],[8,10],[9,11],[10,12],[11,13],[8,9],[14,16],[2,3]]
...
def save_batch_heatmaps(path , batch_image, batch_heatmaps, file_name,joints,
    ...
    '''
    bonelist = [[1,16],[2,4],[3,5],[2,4],[3,5],[4,6],[5,7],[10,8],[9,11],[8,10],[9,11],[10,12],[11,13]]
